...
>(({ className, sideOffset = 19, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-visible rounded-[8px] bg-popover p-2 text-[color:var(--Text-BodyPrimary,#333)] font-[family-name:var(--font-family-All,'Host Grotesk')] text-[length:var(--font-size-Base,16px)] leading-[var(--font-line-height-Base,24px)] font-[var(--font-weight-Regular,400)] shadow-[0px_0px_0px_1px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(0,0,0,0.05),0px_2px_2px_0px_rgba(0,0,0,0.05),0px_4px_4px_0px_rgba(0,0,0,0.05),0px_8px_8px_0px_rgba(0,0,0,0.05),0px_16px_16px_0px_rgba(0,0,0,0.05)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dropdown-popover",
        className,
      )}
      {...props}
    >
